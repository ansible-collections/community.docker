  ...
  platform:
    description:
      ...
      - "Note that since community.docker 3.5.0, the module uses both the image's metadata and the Docker
         ...
         If you notice idempotency problems, please verify whether this is still a problem with the latest
         release of community.docker, and if it is, L(create an issue in the community.docker GitHub repository,
